...
class SettingsViewModelFactory @Inject constructor(private val settingsRepository: Repository.Settings, private val schedulersFacade: SchedulersFacade) : ViewModelProvider.Factory {
